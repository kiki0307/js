...
class level2 extends Phaser.Scene {
  ...
  preload() {
    this.load.image('background2','assets/bg_level2.jpg');
  ...
  create() {
    ...
    this.add.text(650,40, 'Level 2', { font: '30px ', fill: '#ffffff' }).setScrollFactor(0);
  ...
  update() {
    ...
    if (score == 20) {
      score = 0;
      console.log("Collected 20, jump to level 3 Scene Page");
       window.music1.stop();
