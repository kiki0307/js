class catScene3 extends Phaser.Scene {
    ...
    preload() {
        this.load.image('cat_3','assets/failCat3.png');
    ...
    create () {
        ...
        this.add.image(0, 0, 'cat_3').setOrigin(0, 0);
